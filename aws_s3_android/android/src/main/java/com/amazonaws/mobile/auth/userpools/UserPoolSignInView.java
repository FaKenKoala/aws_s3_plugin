...
public class UserPoolSignInView extends LinearLayout {
    ...
    private void setupCredentialsForm(final Context context) {
        ...
        final LayoutParams formViewLayoutParams
    ...
    private void setupLayoutForSignUpAndForgotPassword(final Context context) {
        ...
        final LayoutParams layoutParamsForSignUpAndForgotPassword
            = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        ...
        final LayoutParams layoutParamsForNewAccountText
        ...
        final LayoutParams layoutParamsForForgotPassword
            = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
