...
public class CustomTransferUtility extends TransferUtility {
    ...
    private static final Log LOGGER = LogFactory.getLog(CustomTransferUtility.class);
    ...
    private static void setUserAgentFromConfig(String userAgent) {
        synchronized (LOCK) {
            CustomTransferUtility.userAgentFromConfig = userAgent;
        }
    }

    private static String getUserAgentFromConfig() {
        synchronized (LOCK) {
            if (CustomTransferUtility.userAgentFromConfig == null || CustomTransferUtility.userAgentFromConfig.trim().isEmpty()) {
                return "";
            }
            return CustomTransferUtility.userAgentFromConfig.trim() + "/";
        }
    }
    ...
    /**
     * Builder class for CustomTransferUtility
     */
    public static class CustomBuilder extends Builder {
         ...
         * @return builder
         */
        public CustomBuilder s3Client(final AmazonS3 s3Client) {
            this.s3 = s3Client;
            return this;
        }
         ...
         * @return builder
         */
        public CustomBuilder context(final Context applicationContext) {
         ...
         * @return builder
         */
        public CustomBuilder defaultBucket(final String bucket) {
         ...
         * @return builder
         */
        public CustomBuilder awsConfiguration(AWSConfiguration awsConfiguration) {
            this.awsConfig = awsConfiguration;
            return this;
        }

        /**
         * Sets the TransferUtilityOptions for this CustomTransferUtility instance. Currently,
         ...
         * <p>
         * CustomTransferUtility tu = CustomTransferUtility .builder()
         * .transferUtilityOptions(tuOptions) .build();
         *
         * @param tuOptions The CustomTransferUtility Options object
         * @return builder
         */
        public CustomBuilder transferUtilityOptions(final TransferUtilityOptions tuOptions) {
            this.transferUtilityOptions = tuOptions;
            return this;
        }

        /**
         * @return CustomTransferUtility
         */
        public CustomTransferUtility build() {
            if (this.s3 == null) {
            ...
            if (this.awsConfig != null) {
                try {
                    ...
                    CustomTransferUtility.setUserAgentFromConfig(this.awsConfig.getUserAgent());
                } catch (Exception e) {
            ...
            return new CustomTransferUtility(this.s3, this.appContext, this.defaultBucket, this.transferUtilityOptions);
        }
    }

    /**
     * Minimum calls required.
     * CustomTransferUtility.builder().s3Client(s3).context(context).build()
     *
     * @return The builder object to construct a CustomTransferUtility.
     */
     ...
     * @param tuOptions     The CustomTransferUtility Options object
     */
    private CustomTransferUtility(AmazonS3 s3, Context context, String defaultBucket, TransferUtilityOptions tuOptions) {
        super(s3, context);
        this.s3 = s3;
    ...
    /**
     * Constructs a new CustomTransferUtility specifying the client to use and initializes
     * configuration of CustomTransferUtility and a key for S3 client weak reference.
     *
     * @param s3      The client to use when making requests to Amazon S3
     * @param context The current context
     ...
     */
    @Deprecated
    public CustomTransferUtility(AmazonS3 s3, Context context) {
        super(s3, context);
        this.s3 = s3;
    ...
    private String getDefaultBucketOrThrow() {
        if (this.defaultBucket == null) {
            throw new IllegalArgumentException(
                    "CustomTransferUtility has not been " + "configured with a default bucket. Please use the "
                            + "corresponding method that specifies bucket name or "
                            + "configure the default bucket name in construction of "
                            + "the object. See CustomTransferUtility.builder().defaultBucket() "
                            + "or CustomTransferUtility.builder().awsConfiguration()");
        }
...
//        final long optimalPartSize = (long) Math.max(partSize, MINIMUM_UPLOAD_PART_SIZE);
    ...
    static <X extends AmazonWebServiceRequest> X appendTransferServiceUserAgentString(final X request) {
        request.getRequestClientOptions().appendUserAgent(
                "TransferService/" + CustomTransferUtility.getUserAgentFromConfig() + VersionInfoUtils.getVersion());
        return request;
    }
    ...
    static <X extends AmazonWebServiceRequest> X appendMultipartTransferServiceUserAgentString(final X request) {
        request.getRequestClientOptions().appendUserAgent("TransferService_multipart/"
                + CustomTransferUtility.getUserAgentFromConfig() + VersionInfoUtils.getVersion());
        return request;
    }
